...
from shopify_mcp.tools.media._constants import _MEDIA_PAGE_CAP, MOVES_MAX
from shopify_mcp.tools.media._graphql import GET_PRODUCT_MEDIA, PRODUCT_REORDER_MEDIA
    ...
    def reorder_product_media(
        ...
        if job_id:
            ...
            if poll_result is None:
                ...
                job_line = f"\n  Job        : {numeric} {poll_failed_note(poll_result['error'])}"
